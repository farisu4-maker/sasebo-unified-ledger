                            ...
                            <div className="flex flex-wrap gap-2 justify-center">
                              ...
                              {isActive && (
                                <button
                                  ...
                                  className="bg-rose-500 hover:bg-rose-600 text-white font-medium py-2 px-3 rounded shadow-sm transition-colors text-sm flex-1 text-center min-w-[60px] flex items-center justify-center gap-1"
                                  title="退会処理（削除）"
                                >
                                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
