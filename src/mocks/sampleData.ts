...
export const sampleExpenses: Expense[] = [
  ...
  // 「両方」廃止: 保険料は道院に全額計上
  { id: 'E003', date: '2026-02-20', organization: '道院', category: '保険料', description: 'スポーツ安全保険料（道院分）', amount: 14500, paymentMethod: '現金', enteredById: 'U001', timestamp: '2026-02-20T12:00:00Z' },
];
...
export const sampleBudgets: Budget[] = [
  ...
  // 「両方」廃止: 保険料予算は道院に計上
  { id: 'B003', organization: '道院', category: '保険料', amount: 30000, year: 2026 },
];
